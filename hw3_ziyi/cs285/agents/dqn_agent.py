...
class DQNAgent(object):
    ...
    def step_env(self):
        ...
        randa = np.random.rand(1)[0]
        perform_random_action = randa < eps or self.t < self.learning_starts
        #print(randa, eps, self.t, self.learning_starts, perform_random_action, self.replay_buffer_idx)
