...
def main():
    ...
    parser.add_argument('--batch_size', '-b', type=int, default=10) #steps collected per train iteration
...
# import time
#
# from cs285.agents.pg_agent import ACAgent
...
#     parser.add_argument('--batch_size', '-b', type=int, default=10) #steps collected per train iteration
#     parser.add_argument('--eval_batch_size', '-eb', type=int, default=40) #steps collected per eval iteration
#     parser.add_argument('--train_batch_size', '-tb', type=int, default=10) ##steps used per gradient step
#
#     parser.add_argument('--discount', type=float, default=1.0)
#     parser.add_argument('--learning_rate', '-lr', type=float, default=5e-3)
#     parser.add_argument('--dont_standardize_advantages', '-dsa', action='store_true')
