...
class RL_Trainer(object):
    ...
    def __init__(self, params):
        ...
        self.tf_dir = "BC" + self.params['env_name']
    ...
    def perform_logging(self, itr, paths, eval_policy, train_video_paths, training_logs):
        ...
        if self.log_metrics:
            ...
            # self.tf_logger.add_scalars(self.tf_dir + "/Eval_Return",
            #                            {'mean': np.mean(eval_returns), 'min': np.min(eval_returns),
            #                             'max': np.max(eval_returns)}, itr)
            # self.tf_logger.add_scalar(self.tf_dir + "/Eval_Std", np.std(eval_returns), itr)
            # self.tf_logger.add_scalars(self.tf_dir + "/Train_Return",
            #                            {'mean': np.mean(train_returns), 'min': np.min(train_returns),
            #                             'max': np.max(train_returns)}, itr)
            # self.tf_logger.add_scalars(self.tf_dir + "/Ep_Len",
            #                            {"Eval_AverageEpLen": np.mean(train_ep_lens),
            #                             "Train_AverageEpLen": np.mean(train_ep_lens)}, itr)
            # self.tf_logger.add_scalar(self.tf_dir+"/Loss", logs["Training Loss"], itr)
